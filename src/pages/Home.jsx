    ...
    <div>
      <section className="relative overflow-hidden border-b border-potion-purple/20 bg-radial-fade">
        <div className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 sm:py-28">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link to="/potion-lab" className="btn-secondary">
              Try the Potion Lab ⚗️
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {CATEGORIES.map((c) => (
            ...
            >
              ...
              <span className="font-display text-sm uppercase tracking-wide text-stone-200">
                {c.label}
              </span>
            </Link>
          ))}
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link
            to="/shop"
            className="text-sm text-potion-purple hover:underline"
          >
            View all →
          </Link>
        </div>
      ...
      <section className="border-t border-potion-purple/20 bg-cauldron-900/60">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-16 sm:px-6 md:grid-cols-3">
          <div className="text-center">
            ...
            <h3 className="mt-3 font-display font-semibold text-stone-100">
              Brew Your Own
            </h3>
            <p className="mt-1 text-sm text-stone-400">
              Combine ingredients in the Potion Lab and discover recipes no
              shopkeeper will sell you.
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-stone-400">
              Every successful brew is recorded. Track your progress toward
              mastering all 10 known recipes.
            </p>
          </div>
          <div className="text-center">
            <p className="text-4xl">🎒</p>
            ...
            <p className="mt-1 text-sm text-stone-400">
              Buy, brew, and stockpile your inventory tracks everything you've
              gathered.
            </p>
          </div>
        </div>
